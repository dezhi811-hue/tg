...
a = Analysis(
    ['run_gui.py', 'gui_monitor.py', 'account_manager.py', 'filter.py', 'rate_limiter.py', 'remote_logger.py', 'updater.py', 'version.py', 'batch_import.py', 'account_pool.py', 'pacing.py', 'proxy_registry.py', 'warmup_thread.py'],
    pathex=[],
    binaries=[],
    datas=[],
    hiddenimports=[
